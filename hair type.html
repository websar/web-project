...
<li> <a href="#"> أخرى </a> </li>
        ...
        <h1>انواع الشعر </h1>
        <a href="#oily">الشعر الدهني</a>
        <p></p>
        <a href="#dray">الشعر الجاف </a>
        <p></p>
        <a href="#mix">الشعر المختلط</a>
        <p></p>
        <a href="#normal">الشعر العادي</a>


        <h1 id="oily"> الشعر الدهني</h1>
...
<ul>
    ...
    <ul>
        ...
        <h1 id="mix"> الشعر المختلط </h1>
        <img src="https://1.bp.blogspot.com/-sm8sSmAqlko/XpOll8NF-WI/AAAAAAAAAcU/suXYkL5nlrEHmX2kVCP3tq6RZmvZs2dvwCLcBGAsYHQ/s1600/xx.PNG">
        <p>
        ...
        <h1 id="normal"> الشعر العادي </h1>
        <img src="https://img.yasmina.com/_h7Dq9yaAeAMlrU6GmjmREW5IK0=/700x792/smart/http://harmony-assets-live.s3.amazonaws.com/image_source/8a/db/8adb52ef593cc2dd9a3d29fcca14882d373c850f.jpg" heigh="200" width ="300">
        <p>
